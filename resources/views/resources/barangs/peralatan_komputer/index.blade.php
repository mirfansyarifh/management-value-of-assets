    ...
    <div class="col-md-12">
        ...
        <div class="card-body">
            ...
            <thead>                  
                ...
                <th rowspan="2" style="horizontal-align:center; vertical-align: middle">NAMA ASET TETAP</th>
                <th rowspan="2" style="horizontal-align:center; vertical-align: middle">TYPE/MERK</th>
            ...
            <tr>
                ...
                <td>{{ $barang->properties->merk ?? $barang->kategori['nama'] }}</td>
                <td>
