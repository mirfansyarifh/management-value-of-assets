   ...
   <div class="col-md-12">
      ...
      <div class="card card-success">
         <div class="card-header">
            <h3 class="card-title">Edit Data Barang :<b style="text-transform: uppercase"> {{ $barang->properties->merk ?? $barang->kategori['nama'] }}</b></h3>
         </div>
         <!-- /.card-header -->
         <div class="card-body">
            ...
            <input name="_method" type="hidden" value="PUT">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-3">
                     <div class="form-group">
                        ...
                        <input name="kode_kanwil" type="text" class="form-control @error('kode_kanwil') is-invalid @enderror" maxlength = "3"  value="{{ $barang->kode_kanwil }}" readonly="readonly">
                     </div>
                  </div>
                     <!-- Kode Aset -->
                  <div class="col-sm-3">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-3">
                     <div class="form-group">
                        <label>MERK <i class="fas fa-exclamation-circle"></i></label>
                  ...
                  <div class="col-sm-3">
                     <div class="form-group">
                        <label>NO. RANGKA <i class="fas fa-exclamation-circle"></i></label>
                        <input name="properties[nomor][norangka]" type="text" class="form-control" value="{{ $barang->properties->nomor->norangka ?? '' }}" placeholder="Enter ...">
                     </div>
                  </div>
                     <!-- NO. MESIN -->
                  <div class="col-sm-3">
                     <div class="form-group">
                        <label>NO. MESIN <i class="fas fa-exclamation-circle"></i></label>
                        <input name="properties[nomor][nomesin]" type="text" class="form-control" value="{{ $barang->properties->nomor->nomesin ?? '' }}" placeholder="Enter ..">
                     </div>
                  </div>
                     <!-- >NO. POLIS -->
                  <div class="col-sm-3">
                     <div class="form-group">
                        <label>NO. POLIS <i class="fas fa-exclamation-circle"></i></label>
                        <input name="properties[nomor][nopolis]" type="text" class="form-control" value="{{ $barang->properties->nomor->nopolis ?? '' }}" placeholder="Enter ...">
                     </div>
                  </div>
               </div>
               <div class="row">
                  ...
                  <div class="col-sm-3">
                     <div class="form-group">
                        <label>TAHUN PEMBUATAN <i class="fas fa-exclamation-circle"></i></label>
                        <input name="properties[tahunpembuatan]" type="text" class="form-control" maxlength = "4" value="{{ $barang->properties->tahunpembuatan ?? 'null' }}" placeholder="TAHUN">
                     </div>
                  </div>
                     <!-- TYPE -->
                  <div class="col-sm-3">
                     <div class="form-group">
                     <label>TYPE <i class="fas fa-exclamation-circle"></i></label>
                        <input name="properties[type]" type="text" class="form-control" value="{{ $barang->properties->type ?? 'null' }}" placeholder="Enter ..">
                     </div>
                  </div>
                  <div class="col-sm-3">
                     ...
                     <label>STATUS @error('status_guna') <i class="far fa-times-circle"></i> {{ $message }} @enderror</label> <i>(GUNA/NON-GUNA/HAPUS BUKU)</i>
                        ...
                        <option value="jual" >JUAL</option>
                           <option value="non_kapitalisasi">NON-KAP</option>
                        </select>
                     </div>
                  </div>
                  <div class="col-sm-3">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     ...
                     <label>KETERANGAN</label>
                        <input name="keterangan" type="text" class="form-control" value="{{ $barang->keterangan }}">
                     </div>
