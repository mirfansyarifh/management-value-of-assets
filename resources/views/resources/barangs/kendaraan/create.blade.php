               ...
               <div class="row">
                  ...
                  <div class="col-sm-12">
                     <div class="form-group">
                        ...
                        <select name="kategori_id" class="form-control @error('kategori_id') is-invalid @enderror" style="width: 100%; text-transform: uppercase" name="kategori_id">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-3">
                     <div class="form-group">
                        ...
                        <input name="properties[merk]" type="text" class="form-control" placeholder="Enter ...">
                     </div>
                  </div>
                     <!-- NO. RANGKA -->
                  <div class="col-sm-3">
                     <div class="form-group">
                        ...
                        <input name="properties[nomor][norangka]" type="text" class="form-control" placeholder="Enter ...">
                     </div>
                  </div>
                     <!-- NO. MESIN -->
                  <div class="col-sm-3">
                     <div class="form-group">
                        ...
                        <input name="properties[nomor][nomesin]" type="text" class="form-control" placeholder="Enter ..">
                     </div>
                  </div>
                     <!-- >NO. POLIS -->
                  <div class="col-sm-3">
                     <div class="form-group">
                        ...
                        <input name="properties[nomor][nopolis]" type="text" class="form-control" placeholder="Enter ...">
                     </div>
                  </div>
               </div>
               <div class="row">
                  ...
                  <div class="col-sm-3">
                     <div class="form-group">
                        ...
                        <input name="properties[tahunpembuatan]" type="text" class="form-control" maxlength = "4" placeholder="TAHUN" >
                     </div>
                  </div>
                     <!-- TYPE -->
                  <div class="col-sm-3">
                     ...
                     <label>TYPE <i class="fas fa-exclamation-circle"></i></label>
                        <input name="properties[type]" type="text" class="form-control" placeholder="Enter ..">
                     </div>
                  </div>
                  <div class="col-sm-3">
