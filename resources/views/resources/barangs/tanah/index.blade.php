    ...
    <div class="col-md-12">
        ...
        <div class="card-body">
            ...
            <thead>                  
                ...
                <th rowspan="2" style="horizontal-align:center; vertical-align: middle" >LOKASI ASET TETAP</th>
                <th rowspan="2" style="horizontal-align:center; vertical-align: middle">STATUS TANAH</th>
                <th rowspan="2" style="horizontal-align:center; vertical-align: middle">LUAS (m2)</th>
            ...
            @foreach ($barangs as $barang)
                ...
                <td>{{ $barang->properties->status_tanah ?? 'null' }}</td>
                <td>{{ $barang->properties->luas ?? 'null' }} <a> m2</a></td>
                <td>
