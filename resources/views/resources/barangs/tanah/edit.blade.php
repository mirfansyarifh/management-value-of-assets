   ...
   <div class="col-md-12">
      ...
      <div class="card card-success">
         <div class="card-header">
            <h3 class="card-title">Edit Data Barang :<b style="text-transform: capitalize"> {{ $barang->nama_barang }}</b></h3>
         </div>
         <!-- /.card-header -->
         <div class="card-body">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-3">
                     <div class="form-group">
                        ...
                        <input name="properties[sertifikat][nomor]" type="text" class="form-control"  maxlength = "3" value="{{ $barang->properties->sertifikat->nomor ?? '' }}" placeholder="Enter ...">
                     </div>
                  </div>
                  ...
                  <div class="col-sm-3">
                     <div class="form-group">
                        ...
                        <input name="properties[sertifikat][masa_berlaku]" type="text" class="form-control"  maxlength = "2" value="{{ $barang->properties->sertifikat->masa_berlaku ?? ''}}" placeholder="Enter ...">
                     </div>
                  </div>
                  ...
                  <div class="col-sm-3">
                     <div class="form-group">
                        ...
                        <input name="properties[sertifikat][tanggal_berakhir]" type="text" class="form-control" value="{{ $barang->properties->sertifikat->tanggal_berakhir ?? ''}}" placeholder="TGL/BLN/TAHUN">
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-sm-4">
                     ...
                     <div class="form-group">
                        ...
                        <input name="properties[luas]" type="text" class="form-control" value="{{ $barang->properties->luas ?? ''}}" placeholder="M2">
                     </div>
                  </div>
                  <div class="col-sm-4">
