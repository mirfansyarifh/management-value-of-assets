               ...
               <div class="row">
                  ...
                  <div class="col-sm-4">
                     <div class="form-group">
                        ...
                        <input name="properties[imb][tanggal]" type="text" class="form-control" value="{{ $barang->properties->imb->tanggal ?? '' }}" placeholder="Enter ...">
                     </div>
                  </div>
                     <!-- IMB (nomor) -->
                  <div class="col-sm-4">
                     <div class="form-group">
                        ...
                        <input name="properties[imb][nomor]" type="text" class="form-control" value="{{ $barang->properties->imb->nomor ?? '' }}" placeholder="Enter ...">
                     </div>
                  </div>
                     <!-- IMB (instansi) -->
                  <div class="col-sm-4">
                     <div class="form-group">
                        ...
                        <input name="properties[imb][instansi]" type="text" class="form-control" value="{{ $barang->properties->imb->instansi ?? '' }}" placeholder="Enter ...">
                     </div>
                  </div>
               </div>
               <div class="row">
