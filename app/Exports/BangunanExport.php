...
class BangunanExport implements 
FromQuery, 
WithMapping, 
ShouldAutoSize,
WithHeadings,
     ...
     public function query()
     {
        ...
        public function map($aktivas): array
        {
           ...
           return [
            ...
            $aktivas->barang->properties->imb->nomor.' - '.$aktivas->barang->properties->imb->tanggal.' - '.$aktivas->barang->properties->imb->instansi,
        ...
        public function registerEvents(): array 
        {
                ...
                AfterSheet::class => function (AfterSheet $event) {
                    ...
                    $event->sheet->getStyle('A15:AB15')->applyFromArray([
                        'font' => [
                                'bold' => true
                        ],
                        'alignment' => [
                    ...
                    $event->sheet->getStyle('A16:AB'.$sumStartRow)->applyFromArray([
                        'font' => [
                                'bold' => false
                        ],
                        'borders' => [
